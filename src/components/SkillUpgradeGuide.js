...
const SkillUpgradeGuide = () => {
  ...
  const filteredCriteria = criteria.filter((category) => {
    ...
    const hasSelectedLevel =
      ...
      Object.keys(category.level_descriptions).includes(
    ...
    <div className="skill-upgrade-guide">
      ...
      <Card className="mb-4">
        <Card.Body>
          ...
          <p>
            This interactive guide helps visualize the skill progression path
            across four proficiency levels: Low, Medium, Average, and High.
          </p>
        ...
        <Tab.Content>
          <Tab.Pane eventKey="matrix">
            <Row className="mb-4">
                  ...
                  <Card.Header className="d-flex justify-content-between align-items-center">
                    ...
                    <Dropdown>
                      ...
                      <Dropdown.Menu>
                        ...
                        <Dropdown.Item
                          onClick={() => {
                            const sorted = [...filteredCriteria].sort(
                              (a, b) =>
              ...
              <Col md={8}>
                ...
                {!selectedCategory && (
                  <Alert variant="info">
                    Please select a skill category to view its progression
                    details.
                  </Alert>
                )}
              </Col>
          ...
          <Tab.Pane eventKey="development">
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Accordion>
                  {developmentPaths[selectedRole].map(
                    (path, index) =>
                      path.currentLevel < path.targetLevel && (
                        <Accordion.Item eventKey={index.toString()} key={index}>
                          <Accordion.Header>
                            <strong>{path.category}:</strong> Level{" "}
                            {path.currentLevel} → Level {path.targetLevel}
                          </Accordion.Header>
                          <Accordion.Body>
                            <p>
                              Focus on advancing from Level {path.currentLevel}{" "}
                              to Level {path.currentLevel + 1}
                            </p>
                            ...
                            <ul>
                              ...
                              <li>
                                Seek mentorship from higher-level colleagues
                              </li>
                            </ul>
          ...
          <Tab.Pane eventKey="custom">
            <Card className="mb-4">
              ...
              <Card.Body>
                <p>
                  Drag and drop categories and levels to create your custom
                  skill matrix view.
                </p>
                      ...
                      <Card.Body style={{ minHeight: "200px" }}>
                        {rowFields.map((field, index) => (
                          <Button
                            ...
                            className="m-1"
                            onClick={() =>
                              moveField(field, "rows", "available")
                            }
                          >
                      ...
                      <Card.Body style={{ minHeight: "200px" }}>
                        {columnFields.map((field, index) => (
                          <Button
                            ...
                            className="m-1"
                            onClick={() =>
                              moveField(field, "columns", "available")
                            }
                          >
                            {field.name} <span className="ms-2">×</span>
                          </Button>
                ...
                {rowFields.length > 0 && columnFields.length > 0 ? (
                  ...
                  <Alert variant="info">
                    Click on categories and levels above to add them to your
                    matrix view
                  </Alert>
                )}
                          ...
                          >
                            ...
                            <Accordion.Body>
                              <div className="small text-muted mb-3">
                                Focus on reaching {item.category} Level{" "}
                                {item.level}
                              </div>
          ...
          <Tab.Pane eventKey="team">
            <Card>
              ...
              <Card.Body>
                <p>
                  This view shows the distribution of skills across the team.
                </p>
                  ...
                  <Form.Select
                    onChange={(e) =>
                      handleCategorySelect(
                        criteria.find((c) => c.category === e.target.value)
                      )
                    }
                  >
                    ...
                    <Table bordered className="skill-matrix-table">
                      ...
                      <tbody>
                        {[5, 4, 3, 2, 1].map((level) => {
                          ...
                          const percentage =
                            (memberCount / employees.length) * 100;
                    ...
                    <div className="mt-4">
                      ...
                      <Accordion>
                        <Accordion.Item eventKey="0">
                          ...
                          <Accordion.Body>
                            <p>
                              Based on the current distribution, the team has
                              strengths in levels 3-4 for{" "}
                              {selectedCategory.category}, but could benefit
                              from developing more expertise at level 5.
                            </p>

                            <h6>Recommendations:</h6>
                            <ul>
                              <li>
                                Identify team members at level 4 who can be
                                developed to level 5
                              </li>
                              <li>
                                Consider hiring or training specialists for this
                                skill area
                              </li>
                              <li>
                                Develop mentorship programs to elevate overall
                                team capability
                              </li>
                            </ul>
                          </Accordion.Body>
                        ...
                        <Accordion.Item eventKey="1">
                          ...
                          <Accordion.Body>
                            <p>
                              The following team members have been identified
                              for potential skill development:
                            </p>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>{selectedSkill && selectedSkill.category}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {selectedSkill && (
            <>
                ...
                <Card.Body>
                  <Row>
                    ...
                    <Col md={6} className="mb-3">
                      ...
                      <p>
                        {selectedSkill.medium_description ||
                          "No description available"}
                      </p>
                    </Col>
                    <Col md={6}>
                      ...
                      <p>
                        {selectedSkill.average_description ||
                          "No description available"}
                      </p>
                    </Col>
                    <Col md={6}>
                      ...
                      <p>
                        {selectedSkill.high_description ||
                          "No description available"}
                      </p>
                    </Col>
                  </Row>
                ...
                <tbody>
                  {[1, 2, 3, 4, 5].map((level) => (
                    <tr key={level} className={getLevelClass(level)}>
                      ...
                      <td>
                        {level === 1 &&
                          "Understands basic concepts, requires guidance for all tasks"}
                        {level === 2 &&
                          "Can perform routine tasks with some supervision"}
                        {level === 3 &&
                          "Works independently on most tasks, seeks help for complex issues"}
                        {level === 4 &&
                          "Solves complex problems, can mentor others, contributes to improvements"}
                        {level === 5 &&
                          "Recognized expert, develops new approaches, leads initiatives"}
                      </td>
                    </tr>
                  ))}
                </tbody>
              ...
              {selectedSkill.subcategories &&
                selectedSkill.subcategories.length > 0 && (
                  <>
              ...
              <Accordion>
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    <ul>
                      <li>
                        Coursera: Introduction to {selectedSkill.category}
                      </li>
                      <li>
                        Udemy: Advanced {selectedSkill.category} Techniques
                      </li>
                      <li>
                        LinkedIn Learning: {selectedSkill.category} for
                        Professionals
                      </li>
                    </ul>
                  </Accordion.Body>
                ...
                <Accordion.Item eventKey="2">
                  ...
                  <Accordion.Body>
                    <ul>
                      <li>
                        Beginner: Simple {selectedSkill.category} exercises
                      </li>
                      <li>
                        Intermediate: Building a {selectedSkill.category}{" "}
                        portfolio
                      </li>
                      <li>
                        Advanced: Contributing to open-source{" "}
                        {selectedSkill.category} projects
                      </li>
                    </ul>
                  </Accordion.Body>
                </Accordion.Item>
